module SafeRespawnCrumbleSafeRespawnCrumble

using ..Ahorn, Maple

@mapdef Entity "SafeRespawnCrumble/SafeRespawnCrumble" SafeRespawnCrumble(x::Integer, y::Integer, width::Integer=Maple.defaultBlockWidth, hasOutline::Bool=true)

const placements = Ahorn.PlacementDict(
    "Safe Respawn Crumble (Standalone Mod)" => Ahorn.EntityPlacement(
        SafeRespawnCrumble,
        "rectangle"
    )
)
...
function Ahorn.render(ctx::Ahorn.Cairo.CairoContext, entity::SafeRespawnCrumble, room::Maple.Room)
    texture = "objects/SafeRespawnCrumble/tile"
