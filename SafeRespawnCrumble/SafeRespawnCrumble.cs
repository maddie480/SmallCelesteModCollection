...
namespace Celeste.Mod.SafeRespawnCrumble {
    [Tracked(false)]
    [CustomEntity("SafeRespawnCrumble/SafeRespawnCrumble")]
    class SafeRespawnCrumble : Solid {
        ...
        public SafeRespawnCrumble(EntityData data, Vector2 offset) : base(data.Position + offset, (float) data.Width, 8f, true) {
            ...
            hasOutline = data.Bool("hasOutline", defaultValue: true);
        }
        ...
        public override void Added(Scene scene) {
            ...
            MTexture tileTexture = GFX.Game["objects/SafeRespawnCrumble/tile"];
