...
namespace Celeste.Mod.LifeOnTheMoon {
    [CustomEntity("LifeOnTheMoon/ReskinnableBillboard")]
    ...
    class ReskinnableBillboard : PlaybackBillboard {
        ...
        private static void modAwake(ILContext il) {
            ...
            while (cursor.TryGotoNext(MoveType.After, instr => instr.MatchLdstr("scenery/tvSlices"))) {
                Logger.Log("LifeOnTheMoon/ReskinnableBillboard", $"Making billboard reskinnable at {cursor.Index} in IL for PlaybackBillboard.Awake");
