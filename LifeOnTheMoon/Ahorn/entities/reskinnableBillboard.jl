module LifeOnTheMoonReskinnableBillboard

using ..Ahorn, Maple

@mapdef Entity "LifeOnTheMoon/ReskinnableBillboard" ReskinnableBillboard(x::Integer, y::Integer, width::Integer=Maple.defaultBlockWidth, height::Integer=Maple.defaultBlockHeight, borderTexture::String="scenery/tvSlices")

const placements = Ahorn.PlacementDict(
    "Reskinnable Playback Billboard (Life On The Moon)" => Ahorn.EntityPlacement(
...
function getBillboardRectangles(room::Maple.Room)
    entities = filter(e -> e.name == "LifeOnTheMoon/ReskinnableBillboard", room.entities)
